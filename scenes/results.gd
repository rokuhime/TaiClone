...
func _ready() -> void:
	...
	accurate_amount.text = str(root_viewport.accurate_count)
	accurate_texture.texture = root_viewport.skin.accurate_judgement
	combo_label.text = str(root_viewport.combo)
	early_error_bar.self_modulate = root_viewport.skin.early_color
	early_hit_count.self_modulate = root_viewport.skin.early_color
	...
	inaccurate_amount.text = str(root_viewport.inaccurate_count)
	inaccurate_texture.texture = root_viewport.skin.inaccurate_judgement
	late_error_bar.self_modulate = root_viewport.skin.late_color
	late_hit_count.self_modulate = root_viewport.skin.late_color
